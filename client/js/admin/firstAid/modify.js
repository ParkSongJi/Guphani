...
var id = herf.split('=')[1]
let link = `https://www.guphani.com/admin/firstAid/modify?id=${id}`;
...
const editor = new toastui.Editor({
    ...
    hooks: {
        addImageBlobHook: async (blob, callback) => {
            ...
            try {
                const response = await fetch('https://www.guphani.com/admin/firstAid/modify/imgUpload', {
                    method: 'POST',
                    body: formData,
                    headers: headers
                });
...
async function handleEditor(blob, callback) {
    ...
    const data = await fetch(`https://www.guphani.com/admin/firstAid/modify/${id}`, {
        method: "PUT",
