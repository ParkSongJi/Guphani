...
var id = herf.split('=')[1]
let link = `https://port-0-guphani-final-1gksli2alpullmg3.sel4.cloudtype.app:8080//admin/firstAid/modify?id=${id}`;
...
const editor = new toastui.Editor({
    ...
    hooks: {
        addImageBlobHook: async (blob, callback) => {
            ...
            try {
                const response = await fetch('https://port-0-guphani-final-1gksli2alpullmg3.sel4.cloudtype.app:8080//admin/firstAid/modify/imgUpload', {
                    method: 'POST',
                    body: formData,
                    headers: headers
                });
...
async function handleEditor(blob, callback) {
    ...
    const data = await fetch(`https://port-0-guphani-final-1gksli2alpullmg3.sel4.cloudtype.app:8080//admin/firstAid/modify/${id}`, {
        method: "PUT",
